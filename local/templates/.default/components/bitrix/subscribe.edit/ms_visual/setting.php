...
<tr valign="top">
	<td width="40%">
		<p>
			<span class="title">
				<?echo GetMessage("subscr_email")?><span class="starrequired">*</span><br />
			</span>
			<input class="input_text_style" type="text" name="EMAIL" value="<?=$arResult["SUBSCRIPTION"]["EMAIL"]!=""?$arResult["SUBSCRIPTION"]["EMAIL"]:$arResult["REQUEST"]["EMAIL"];?>" size="30" maxlength="255" />
		</p>
		<p>
			<span class="title">
...
<tfoot><tr><td colspan="2">
	<input class="btn bt3 bt-medium" type="submit" name="Save" value="<?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?>" />
	<input class="btn bt2 bt-medium" type="reset" value="<?echo GetMessage("subscr_reset")?>" name="reset" />
</td></tr></tfoot>
</table>
