...
if (!empty($arResult['ITEMS']))
{
	...
	?>
	<h3><? echo GetMessage('CVP_TPL_MESS_RCM') ?></h3>

	<div class="bx_item_list_you_looked_horizontal bx_catalog_grid col<? echo $arParams['LINE_ELEMENT_COUNT']; ?>">

	<?
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		$strMainID = 'bigdata_'.$this->GetEditAreaId($arItem['ID'] . $key);
		...
		?>
	<div class="product <? echo($arItem['SECOND_PICT'] && $arParams ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>" id="<? echo $strMainID; ?>">
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) // Simple Product
	{
		...
		<div class="bx_catalog_item_controls"><?
			if ($arItem['CAN_BUY'])
			{
				...
				<div class="bx_catalog_item_controls_blocktwo">
					<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_cart btn bt1" href="javascript:void(0)" rel="nofollow"><?
						echo('' != $arParams['MESS_BTN_ADD_TO_BASKET'] ? $arParams['MESS_BTN_ADD_TO_BASKET'] : GetMessage('CVP_TPL_MESS_BTN_ADD_TO_BASKET'));
						?></a>
				</div>
			<?
			}
			else
			{
				?>
				<div class="bx_catalog_item_controls_blockone">
					<a class="btn bt2 bx_detail bx_rcm_view_link" data-product-id="<?=$arItem['ID']?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" rel="nofollow">
	...
	?>
		...
		<div class="bx_catalog_item_controls touch">
			<a class="btn bt2 bx_detail bx_rcm_view_link" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" data-product-id="<?=$arItem['ID']?>"><?
				echo('' != $arParams['MESS_BTN_DETAIL'] ? $arParams['MESS_BTN_DETAIL'] : GetMessage('CVP_TPL_MESS_BTN_DETAIL'));
				?></a>
		</div>
	<?
