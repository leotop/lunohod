...
$arFilterFields = array (
    'AUTHORS' => GetMessage("AUTHORS"),
    'PAINTERS' => GetMessage("PAINTERS"),
    'PUBLISHERS' => GetMessage("PUBLISHERS"),
    'TRANSLATERS' => GetMessage("TRANSLATERS"),
);
...
$arTemplateParameters = array(
    ...
    "FILTER_FIELD" => Array(
        "NAME" => GetMessage("T_IBLOCK_DESC_NEWS_FILTER_FIELD"),
        "TYPE" => "LIST",
        "MULTIPLE" => "N",
