...
<div class="bx_catalog_list">
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		?>
		<div data-pid="<?=$arItem['ID']?>" class="clearfix product <? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?> p_id_<?=$arItem['ID']?> <?=$stock?>">
                                ...
                                <div class="item_props">
									...
									<ul>
										...
										<li>
                                            <? echo $arOneProp['NAME']; ?>:
											<b>
                                                <?if (!empty($arResult['GROUPS_ID_LINKING'][$arItem['ID']]['ID']) && ($arOneProp['ID'] == '131')){
                                                ?><a href='/catalog/serii/<?=$arResult['GROUPS_ID_LINKING'][$arItem['ID']]['ID']?>/'><?=$arResult['GROUPS_ID_LINKING'][$arItem['ID']]['SERIES_NAME']?></a>
                                                <?} else {?>
												<?echo (is_array($arOneProp['DISPLAY_VALUE']) ? implode('<br>', $arOneProp['DISPLAY_VALUE']) : $arOneProp['DISPLAY_VALUE']);
                                                }?>
											</b>
