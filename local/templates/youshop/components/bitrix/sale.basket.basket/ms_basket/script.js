...
function updateBasketTable(basketItemId, res)
{
	...
	if (basketItemId !== null)
	{
		...
		for (i = 0; i < arColumns.length; i++)
		{
			...
			else if (arColumns[i] == 'QUANTITY')
			{
				...
				oCellQuantityHTML += '<div class="cart-counter can_change">';
				...
				{
					oCellQuantityHTML += '<div class="quantity_control">\
				...
				if (arItem.hasOwnProperty('MEASURE_TEXT') && arItem['MEASURE_TEXT'].length > 0)
					oCellQuantityHTML += '<div class="measure_text">' + arItem['MEASURE_TEXT'] + '</div>';
	...
	if (BX('coupon'))
	{
		...
		BX('coupon').className = couponClass+' input_text_style ';
	}
...
{
	BX.removeClass(BX("basket_toolbar_button"), "bt3");
	BX.removeClass(BX("basket_toolbar_button_delayed"), "bt3");
	BX.removeClass(BX("basket_toolbar_button_subscribed"), "bt3");
	BX.removeClass(BX("basket_toolbar_button_not_available"), "bt3");
	...
	if (val == 2)
	{
		...
		if (BX("basket_items_delayed"))
		{
			...
			BX.addClass(BX("basket_toolbar_button_delayed"), "bt3");
	...
	else if(val == 3)
	{
		...
		if (BX("basket_items_subscribed"))
		{
			...
			BX.addClass(BX("basket_toolbar_button_subscribed"), "bt3");
	...
	else if (val == 4)
	{
		...
		if (BX("basket_items_not_available"))
		{
			...
			BX.addClass(BX("basket_toolbar_button_not_available"), "bt3");
	...
	else
	{
		if (BX("basket_items_list"))
		{
			...
			BX.addClass(BX("basket_toolbar_button"), "bt3");
